                                ...
                                unsigned direction, int val)
{
	...
	pr_info("MCP23016: Function - mcp23016_direction\n");
	pr_info("MCP23016: offset: %d\n", offset);
	pr_info("MCP23016: direction: %d\n", direction);
	pr_info("MCP23016: val: %d\n", val);
	pr_info("MCP23016: bank: %d\n", bank);
	pr_info("MCP23016: bit: %d\n", bit);
